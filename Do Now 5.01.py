...
Write down what was printed out. What type is my_dictionary? A dictionary

Add a line of code that will print the definition of 'chair', then run the code again.

Write down what happens if you use my_dictionary['kittens']? What do you think that error means? kittens is not in the dictionary
'''
